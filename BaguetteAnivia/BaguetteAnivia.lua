...
function Anivia:LaneClear()
	...
	for i, jungleMinion in pairs(jungleMinions.objects) do
		if jungleMinion ~= nil and not jungleMinion.dead and jungleMinion.maxHealth > 6 then
...
function Anivia:Menu()
	...
	Param:addSubMenu("WaveClear Settings", "WaveClear");
		Param.WaveClear:addParam("UseQ", "Use (Q) Spell in WaveClear :" , SCRIPT_PARAM_ONOFF, false);
...
function Anivia:OnUpdateBuff(unit, buff, stacks)
